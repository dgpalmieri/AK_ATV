...
{
    public bool is_VR=false; /*!< Controls virtual reality (VR) user interface */
    
    public float max_angular_velocity=100.0f; /*!< rads/sec wheel speed cap (hard limit seems to be like 35 rads/sec, equiv to 24mph). Read by the wheels during setup. */
    public float mass_tire=10.0f; /*!< hung mass of tire and hub. Read by the wheels during setup. */
    public float mass_engine=150.0f; /*!< center mass of vehicle. Read by the wheels during setup. */
    public float mass_vehicle; /*!< Read by the wheels during setup. */
    public float angular_drag_tire=0.001f; /*!< per-tire angular drag. Read by the wheels during setup. */

    public int drive_wheels=2;  /*!< 2 == rear wheel drive.  4 == all wheel drive. Read by the wheels during driving */
    public float max_motor_torque=300.0f/2; /*!< N-m of motor torque (per wheel). Read by the wheels during driving */
    public float cur_motor_power=0.0f; /*!< Read by the wheels during driving */
    public float cur_steer=0.0f; /*!< Read by the wheels during driving */

    private Rigidbody rb; /*!< Extracted physical motion of the vehicle */
    public Vector3 last_velocity; /*!< m/s velocity. Extracted physical motion of the vehicle */
    public Vector3 acceleration; /*!< m/s^2 acceleration. Extracted physical motion of the vehicle */
    public float centripital; /*!< sideways acceleration, in gravities. Extracted physical motion of the vehicle */
    public float drive; /*!< m/s velocity relative to forward direction. Extracted physical motion of the vehicle */
    public float skid; /*!< m/s velocity perpendicular to forward direction. Extracted physical motion of the vehicle */
    public float mph; /*!< scalar velocity, in miles/hour. Extracted physical motion of the vehicle */
    ...
    public Vector3 vehicle_COM; /*!< DEBUG display vehicle center of mass. Part of driver properties */
    public Vector3 driver_COM; /*!< DEBUG display driver center of mass. Part of driver properties */
    public Vector3 vehicle_position; /*!< DEBUG display vehicle local position relative to itself. Part of driver properties */
    private Vector3 driver_position; /*!< DEBUG display driver local position relative to the vehicle. Part of driver properties */
    ...
    private bool allow_force = false; /*!< Part of driver properties. WORKAROUND: prevent liftoff during spawn */
    ...
    public Material force_material; /*!< force shader (reads vertex colors). Part of the debugging for force visualization */
    private const int nforces=1+4; /*!< The number of forces, the vehicle and the wheels */
    private const int nforce_copies=10; /*!< smoother bouncing. Part of the debugging for force visualization */
    private int force_index=0;
    private Color[]   force_color=new Color[nforces*nforce_copies]; /*!< drawn color. Part of the debugging for force visualization */
    private Vector3[] force_start=new Vector3[nforces*nforce_copies]; /*!< start location in world space (meters). Part of the debugging for force visualization */
    private Vector3[] force_vec=new Vector3[nforces*nforce_copies]; /*< actual force vector (Newtons). Part of the debugging for force visualization */
    public float force_scaling=1.0f/1000.0f; /*!< force (N) to onscreen meters. Part of the debugging for force visualization */
