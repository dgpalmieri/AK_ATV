...
{
    public static bool GameIsPaused = false; /*!< Flag for checking if the game is paused */
    public bool inOptionsMenu = false; /*!< Flag for if user is in the options menu */
    public GameObject pauseMenuUI; /*!< The object for the pause menu UI. This is assigned in Unity. */
    public GameObject optionsUI; /*!< The object for the options UI. This is assigned in Unity. */
